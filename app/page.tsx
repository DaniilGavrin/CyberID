    ...
    return (
        <main className="min-h-screen bg-black flex flex-col items-center justify-center relative overflow-hidden">
            ...
            <div className="relative z-10 text-center">
                {/* Заголовок с глитчем */}
                <h1
                    className="text-[64px] font-black text-cyan-400 animate-slide-up mt-[-200px] tracking-wider uppercase animate-glitch cursor-pointer"
                    data-text="CyberID Project">
                    CyberID Project
                </h1>
                ...
                <div className="flex gap-6 mt-12 animate-slide-up justify-center" style={{animationDelay: '0.4s'}}>
                    ...
                    {/* Кнопка подробнее*/}
                    <button className="group relative px-8 py-3 bg-cyan-950/30 border border-cyan-700/30 text-cyan-600 font-mono font-semibold uppercase tracking-wider hover:border-cyan-400 hover:text-cyan-400 transition-all duration-300 hover:drop-shadow-[0_0_15px_rgba(34,211,238,0.6)]">
            ...
            {/* Декоративные линии */}
            <div className="absolute top-1/2 left-1/4 w-32 h-px bg-gradient-to-r from-transparent via-cyan-500/30 to-transparent" />
            <div className="absolute top-1/2 right-1/4 w-32 h-px bg-gradient-to-r from-transparent via-cyan-500/30 to-transparent" />
