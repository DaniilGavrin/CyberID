              ...
              <span className="relative drop-shadow-[0_0_8px_rgba(34,211,238,0.8)] group-hover:drop-shadow-[0_0_20px_rgba(34,211,238,1)] transition-all duration-300 inline-block group-hover:translate-x-1">
                &gt; Начать работу &gt;
                        ...
                        <button
                            ...
                            className="group relative px-8 py-3 bg-cyan-950/30 border border-cyan-700/30 text-cyan-600 font-mono font-semibold uppercase tracking-wider hover:border-cyan-400 hover:text-cyan-400 transition-all duration-300 hover:drop-shadow-[0_0_15px_rgba(34,211,238,0.6)]"
                        >
