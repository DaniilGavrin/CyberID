                    ...
                    <div
                        ...
                        <div className="mt-6 p-4 bg-cyan-950/20 border border-cyan-500/20 rounded backdrop-blur-sm">
                            ...
                            <p className="mt-2 text-cyan-200/70">
                                CyberID - это провайдер аккаунтов нового поколения,
                                Мы совмещаем усиленную защиту аккаунтов, и быстроту работы сервиса, 
                                за счет стойких алгоритмов шифрования серверной части,
                                и быстрых технологий фронта, а также удобство управления панелью,
                                а дизайн в стиле киберпанка заинтересует наших как маленьких так и людей старшего поколения
                            </p>
                        </div>
